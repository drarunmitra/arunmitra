---
title: "Three-Day Workshop on Reproducible and AI-aided Health Data Analysis at IQRAA"
subtitle: "Reproducible, AI-aided health data analysis and EDA training in R"
excerpt: "A multi-day data analysis workshop series in R, including an AI-basics module and a hands-on EDA module using tidyverse verbs on a WHO tuberculosis dataset."
date: 2026-06-04
author: "Arun Mitra"
draft: false
layout: single
...
- icon: desktop
  icon_pack: fas
  name: Materials
  url: https://drarunmitra.github.io/iqraa-working-with-data-eda/
- icon: github
  icon_pack: fab
  name: Code
  url: https://github.com/drarunmitra/iqraa-working-with-data-eda
---
...
- Participants gain fluency in tidyverse data transformation and `ggplot2` visualisation.
- Builds an end-to-end EDA workflow from raw data to summary tables and figures.
